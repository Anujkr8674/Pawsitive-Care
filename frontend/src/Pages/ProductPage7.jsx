...
const ProductPage6 = () => {
  ...
  const product = {
    // id: `product7-${selectedSize}-${selectedColor}`, // Unique ID for the product
    id: 7, // Use a unique id for the product
    name: 'Trixie Cat Teaser - Playing Rod with Fish 7',
    price: 206,
    discount: 'Save 25%', 
  ...
  return (
    <div className="product-page">
      ...
      <div className="product-details">
        <h1>Trixie Cat Teaser - Playing Rod with Fish 7</h1>
