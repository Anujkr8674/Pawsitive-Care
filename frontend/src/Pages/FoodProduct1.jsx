...
//   // Product details
//   const product = {
//     id: 11, // Use a unique id for the product
//     name: 'Cat Food1',
//     price: 206,
...
const FoodProduct1 = () => {
  ...
  const product = {
    id: 11, // Use a unique id for the product
    name: 'Trixie Cat Teaser - Playing Rod with Fish 11',
    price: 188,
    discount: 'Save 25%', 
    image: images[selectedImage], // Use the selected image as the main image
    // quantity: parseInt(quantity), // Ensure quantity is passed as a number
  ...
  return (
    <div className="product-page">
      ...
      <div className="product-details">
        <h1>Trixie Cat Teaser - Playing Rod with Fish 11</h1>
        <p className="price">Rs. 188 <span id='span1'>{product.discount}</span></p>
        <div className="description">
          <p>
            This jumper is knitted from a wool and viscose blend with a slight stretch to help maintain shape and aid recovery when worn.
          </p>
        </div>
        <button className="add-to-cart" onClick={handleAddToCart}> {/* Call handleAddToCart without parameters */}
          Add to Cart
        </button>
      </div>
      <ToastContainer />
