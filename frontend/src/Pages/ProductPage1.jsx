...
const ProductPage = () => {
  ...
  // Product details
  const product = {
    // id: `product1-${selectedSize}-${selectedColor}`, // Unique ID with size and color
    id: 1, // Use a unique id for the product
    name: 'Trixie Cat Teaser - Playing Rod with Fish 1',
    price: 188  ,
    discount: 'Save 25%',
  ...
  return (
    <div className="product-page">
      ...
      <div className="product-details">
        <h1>Trixie Cat Teaser - Playing Rod with Fish 1</h1>
        <p className="price">₹ 188 <span id='span1'>{product.discount}</span></p>
