...
const ProductPage2 = () => {
  ...
  const product = {
    ...
    id: 3, // Use a unique id for the product
    name: 'Trixie Cat Teaser - Playing Rod with Fish 3',
    price: 206,
    discount: 'Save 25%', 
  ...
  return (
    <div className="product-page">
      ...
      <div className="product-details">
        <h1>{product.name}</h1>
        <p className="price">Rs. {product.price} <span id='span1'>{product.discount}</span></p>
