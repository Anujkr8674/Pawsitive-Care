...
const AdminProtectedRoute = ({ children }) => {
  ...
  const token = localStorage.getItem('adminToken'); // Check if the admin is logged in
  ...
  // If confirmed, navigate to the admin login page
  if (redirect) {
  ...
  if (showModal) {
    return (
      <>
        <Modal
          message="You need to log in as an admin to access this page."
