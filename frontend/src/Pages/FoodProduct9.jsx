...
const FoodProduct9 = () => {
  ...
  // Product details
  const product = {
    id: 19, // Use a unique id for the product
    name: 'Trixie Cat Teaser - Playing Rod with Fish 19',
    price: 206,
    discount: 'Save 25%', 
  ...
  return (
    <div className="product-page">
      ...
      <div className="product-details">
        <h1>Trixie Cat Teaser - Playing Rod with Fish 19</h1>
