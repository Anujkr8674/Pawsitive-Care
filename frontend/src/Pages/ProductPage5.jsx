...
const ProductPage4 = () => {
  ...
  // Product details
  const product = {
    // id: `product5-${selectedSize}-${selectedColor}`, // Unique ID for the product
    id: 5, // Use a unique id for the product
    name: 'Trixie Cat Teaser - Playing Rod with Fish 5',
    price: 206,
    discount: 'Save 25%', 
  ...
  return (
    <div className="product-page">
      ...
      <div className="product-details">
        <h1>Trixie Cat Teaser - Playing Rod with Fish 5</h1>
