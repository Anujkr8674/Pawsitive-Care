...
const FoodProduct8 = () => {
  ...
  // Product details
  const product = {
    id: 18, // Use a unique id for the product
    name: 'Trixie Cat Teaser - Playing Rod with Fish 18',
    price: 206,
    discount: 'Save 25%', 
  ...
  return (
    <div className="product-page">
      ...
      <div className="product-details">
        <h1>Trixie Cat Teaser - Playing Rod with Fish 18</h1>
