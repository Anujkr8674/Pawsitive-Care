...
const ProductPage5 = () => {
  ...
  const product = {
    // id: `product6-${selectedSize}-${selectedColor}`, // Unique ID for the product
    id: 6, // Use a unique id for the product
    name: 'Trixie Cat Teaser - Playing Rod with Fish 6',
    price: 188,
    discount: 'Save 25%', 
  ...
  return (
    <div className="product-page">
      ...
      <div className="product-details">
        <h1>Trixie Cat Teaser - Playing Rod with Fish 6</h1>
